...
class CNN_LSTM(nn.Module):
    def __init__(self, lstm_hidden_size=128, cnn_first_output_size=16, cnn_final_output_size=64, num_classes=1, cnn_dropout_rate=0.53, lstm_dropout_rate=0.24):
        """
        ...
        :param float, optional cnn_dropout_rate: Dropout probability applied to CNN layers (default is 0.53).
        :param float, optional lstm_dropout_rate: Dropout probability applied to LSTM layers (default is 0.24).
        """
        super(CNN_LSTM, self).__init__()
        self.NAME = 'CNN LSTM BatchNorm'
        ...
        self.cnn = nn.Sequential(
            ...
            nn.BatchNorm2d(cnn_first_output_size),
            nn.ReLU(),
            ...
            nn.BatchNorm2d(cnn_first_output_size*2),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.Dropout2d(p=cnn_dropout_rate),
            ...
            nn.BatchNorm1d(cnn_final_output_size),
            nn.ReLU(),
