...
class Trainer:
    ...
    def save_model(self, model_name):
        ...
        :param string model_name: The name of the model to save.
        """
    ...
    def test(self, metrics_path, model_name):
        ...
        self.save_metrics_to_csv(metrics_path, 0, 0, 'test different robot', test_loss, test_accuracy, test_precision,
                                 test_recall, test_f1)
...
model = cnn_lstm_model_batchnorm.CNN_LSTM()
...
if __name__ == "__main__":    #Bestpractice for Multiprocessing (num_workers > 0)
    ...
    root_dir_train = "DIRECTORY TO TRAINING DATA OF MANUAL SPLIT"
    root_dir_test_val = "DIRECTORY TO TEST AND VALIDATION DATA OF MANUAL SPLIT"

    train_dataset = dataset.Dataset_BA(root_dir_train, transform=transform)
